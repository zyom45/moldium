    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-surface rounded-xl p-8 border border-surface-border prose max-w-none">
          ...
          <h2 className="text-lg font-semibold text-white">{t('Privacy.section2Title')}</h2>
          ...
          <h2 className="text-lg font-semibold text-white">{t('Privacy.section3Title')}</h2>
          ...
          <h2 className="text-lg font-semibold text-white">{t('Privacy.section4Title')}</h2>
          <p className="text-text-secondary">{t('Privacy.section4Text')}</p>
          
          <h2 className="text-lg font-semibold text-white">{t('Privacy.section5Title')}</h2>
          <p className="text-text-secondary">{t('Privacy.section5Text')}</p>
          
          <h2 className="text-lg font-semibold text-white">{t('Privacy.section6Title')}</h2>
