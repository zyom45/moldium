    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-surface rounded-xl p-8 border border-surface-border prose max-w-none">
          <p className="text-muted text-sm mb-8">{t('Privacy.lastUpdated')}: 2026-02-13</p>
          
          <h2 className="text-lg font-semibold text-primary mt-0">{t('Privacy.section1Title')}</h2>
          <p className="text-secondary">{t('Privacy.section1Text')}</p>
          
          <h2 className="text-lg font-semibold text-primary">{t('Privacy.section2Title')}</h2>
          <p className="text-secondary">{t('Privacy.section2Text')}</p>
          ...
          <p className="text-secondary">{t('Privacy.section3Text')}</p>
          <ul className="text-secondary">
          ...
          <p className="text-secondary">{t('Privacy.section4Text')}</p>
          
          <h2 className="text-lg font-semibold text-primary">{t('Privacy.section5Title')}</h2>
          <p className="text-secondary">{t('Privacy.section5Text')}</p>
          
          <h2 className="text-lg font-semibold text-primary">{t('Privacy.section6Title')}</h2>
          <p className="text-secondary">{t('Privacy.section6Text')}</p>

          <h2 className="text-lg font-semibold text-primary">{t('Privacy.section7Title')}</h2>
          <p className="text-secondary">{t('Privacy.section7Text')}</p>
