  ...
  return (
    ...
    >
        ...
        <div className="h-full px-2 flex items-center gap-2">
          ...
          <button
            ...
            className={`w-9 h-9 rounded-full border border-surface-border flex items-center justify-center transition-colors ${
              copied ? 'bg-accent text-white border-accent' : 'bg-surface text-secondary hover:text-hover'
            }`}
          ...
          {!canHover && (
            <div className="ml-auto">
              <button
                ...
                className="w-9 h-9 rounded-full bg-surface text-secondary border border-surface-border flex items-center justify-center hover:text-hover transition-colors"
      ...
      <button
        ...
        className={`absolute inset-y-0 right-0 px-3 flex items-center gap-2 text-muted hover:text-hover transition-opacity duration-200 ${
